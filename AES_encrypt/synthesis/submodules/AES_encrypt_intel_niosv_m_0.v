...
`timescale 1 ps / 1 ps
module AES_encrypt_intel_niosv_m_0 (
	...
	AES_encrypt_intel_niosv_m_0_hart #(
	...
	AES_encrypt_intel_niosv_m_0_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	AES_encrypt_intel_niosv_m_0_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	AES_encrypt_intel_niosv_m_0_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
